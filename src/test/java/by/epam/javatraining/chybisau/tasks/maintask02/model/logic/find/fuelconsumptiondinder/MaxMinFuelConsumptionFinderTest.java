...
public class MaxMinFuelConsumptionFinderTest {
    ...
    @Test
    public void testGetMaxFuelConsumptionPlane() {
        ...
        planes.add(an124);
        planes.add(an225);
        assertEquals(an225, new MaxMinFuelConsumptionFinder().getMaxFuelConsumptionPlane(planes));
    }

    @Test
    public void testGetMinFuelConsumptionPlane() {
        List<Plane> planes = new ArrayList<>();
        planes.add(boing737500);
        planes.add(boing737300);
        planes.add(airbus_A320neo);
        planes.add(an124);
        planes.add(an225);
        assertEquals(boing737300, new MaxMinFuelConsumptionFinder().getMinFuelConsumptionPlane(planes));
    }
}